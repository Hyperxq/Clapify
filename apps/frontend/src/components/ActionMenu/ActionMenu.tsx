...
export const ActionMenu = (formData: Partial<AppreciationData>) => {
  const customTheme: CustomFlowbiteTheme = {
    button: {
      color: {
        purple:
          'border-[#7F56D9] border-solid border-[1px] bg-[#8B67DC] focus:ring-4 focus:ring-purple-300 enabled:hover:bg-[#784DD6] p-0 px-2 py-3',
  ...
  const { handleDownload, handleCopy } = useCardImageActions({
    formData,
    fetchResource,
    copyToClipboard,
  });
    ...
    <Flowbite theme={{ theme: customTheme }}>
      <nav className="flex flex-col gap-[16px] pt-1">
        <Button onClick={handleDownload} size="xs" color="purple">
          ...
          >
            <path
              d="M16.8355 16.8971H1.31799M14.2493 8.27629L9.07676 13.4488M9.07676 13.4488L3.90425 8.27629M9.07676 13.4488V1.37961"
              stroke="white"
              strokeWidth="1.72417"
              strokeLinecap="round"
